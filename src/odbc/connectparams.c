...
ODBCINSTGetProperties(HODBCINSTPROPERTY hLastProperty)
{
	...
	hLastProperty->pszHelp = (char *) tds_strdup("Name of FreeTDS connection to connect to.\n"
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("Name of server to connect to.\n"
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("The hostname or ip address of the server.");
	...
	hLastProperty->pszHelp = (char *) tds_strdup("TCP/IP Port to connect to.");
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("Default database.");
	...
	hLastProperty->pszHelp = (char *) tds_strdup("The TDS protocol version.\n"
	...
	hLastProperty->pszHelp = (char *) tds_strdup("The default language setting.");
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("Text datatype limit.");
...
/*
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("User ID (Beware of security issues).");
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("Password (Beware of security issues).");
*/
...
/*
	...
	hLastProperty->pszHelp = (char *) tds_strdup("The server authentication mechanism.");
*/
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("The default domain to use when using Domain Authentication.");
	...
	tds_strlcpy(hLastProperty->szValue, "", INI_MAX_PROPERTY_VALUE);
	hLastProperty->pszHelp = (char *) tds_strdup("Size of network packets.");
